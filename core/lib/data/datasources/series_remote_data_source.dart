...
import '../../data/models/series_detail_model.dart';
import '../../data/models/series_model.dart';
import '../../data/models/series_response.dart';
import '../../utils/exception.dart';

abstract class SeriesRemoteDataSource {
  Future<List<SeriesModel>> getPopularSeries();
  Future<List<SeriesModel>> getOnGoingSeries();
...
class SeriesRemoteDataSourceImpl implements SeriesRemoteDataSource {
  ...
  @override
  Future<List<SeriesModel>> getOnGoingSeries() async {
    final response =
