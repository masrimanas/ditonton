...
void main() {
  ...
  group('get Now Playing Series', () {
    final tSeriesList = SeriesResponse.fromJson(
            json.decode(readJson('dummy_data/on_going_series.json')))
        .seriesList;
    ...
    test('should return list of Series Model when the response code is 200',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/tv/on_the_air?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/on_going_series.json'), 200));
      // act
      final result = await dataSource.getOnGoingSeries();
      // assert
    ...
    test(
      ...
      // act
      final call = dataSource.getOnGoingSeries();
      // assert
